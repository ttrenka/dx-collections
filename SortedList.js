define(["./main"], function(main){
	var SortedList=function(/* object? */ dictionary){
		//	summary
		...
		this.clone=function(){
			...
			return new SortedList(this);	//	SortedList
		};
		...
		this.getIterator=function(){
			...
			return new main.DictionaryIterator(items);	//	dojox.collections.DictionaryIterator
		};
		...
		if(dictionary){
			...
			while (!e.atEnd()){
				var item=e.get();
				q[q.length]=items[item.key]=new main.DictionaryEntry(item.key,item.value);
			}
			q.sort(sorter);
		}
	};
